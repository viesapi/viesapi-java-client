...
public enum LegalForm {
	...
	/**
	 * Convert int value to type
	 * @param id int value
	 * @return type object
	 */
	public static LegalForm parse(int id)
	{
		for (LegalForm t: LegalForm.values()) {
			if (t.getId() == id) {
				return t;
			}
		}

		throw new IllegalArgumentException("Invalid legal form id");
	}
}
